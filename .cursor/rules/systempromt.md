...
`module_relationship_tracker.md`、`doc_tracker.md` 和迷你跟踪器至关重要。 详细步骤在设置/维护插件 (`cline_docs/prompts/setup_maintenance_plugin.md`) 中。 **所有跟踪器管理都必须使用 `dependency_processor.py` 脚本完成。**
